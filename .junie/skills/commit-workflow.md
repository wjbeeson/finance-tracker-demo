...
- The branch name IS the Jira ticket ID. Nothing else.
...
### 6. CI Integration
- The `@junie-agent` tag is already included in every commit message (see Step 4).
- This enables automated PR creation and Junie analysis on all commits.
