        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src="/acme-logo.svg" alt="Acme Expenses" className="w-10 h-10 rounded-full" />
              <div>
                <h1 className="text-xl font-bold italic text-slate-800 dark:text-slate-100">Acme Expenses</h1>
